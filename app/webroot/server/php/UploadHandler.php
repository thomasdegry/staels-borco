...
class UploadHandler
{
    ...
    protected function handle_form_data($file, $index) {
        ...
        $this->options['album_id'] = $_REQUEST['album_id'];
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                $file->upload_to_db = $this->add_img($file->name, $file->size);
                if ($append_file) {
                    file_put_contents(
                        $file_path,
    ...
    *****************************************************/
    ...
    function query($query) {  
        ...
        if (!$link) {  
            die(mysql_error('Could not connect to DB'));  
        }
        $db_selected = mysql_select_db($database);  
        if (!$db_selected) {  
            die(mysql_error('Could not select DB'));  
        }  
    ...
    *****************************************************/
    ...
    function add_img($whichimg, $size) {  
        $add_to_db = $this->query("INSERT INTO pictures(name, size, gallery_id) VALUES('".$whichimg."', '".$size."', '". $this->options['album_id'] ."')") or die(mysql_error('Could not add to db'));
        return $add_to_db;  
    }
    ...
    *****************************************************/
    ...
    function delete_img($delimg)  {  
        $delete_from_db = $this->query("DELETE FROM pictures WHERE name = '$delimg'") or die(mysql_error());  
